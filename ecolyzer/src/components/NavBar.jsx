        ...
        <div>
            <div className="top-0 mb-1 w-screen h-32 flex justify-between items-center box-border text-5xl text-green-800 fixed bg-white z-10">
                <div className="h-fit flex justify-start items-center">
                    <div className="h-full font-josefin ml-5 p-2 pt-5 bg-green-800 rounded-2xl text-white text-4xl sm:text-6xl tracking-wide">ECOLYZER</div>
                </div>
                <ul className="font-josefin h-fit mr-5 hidden lg:flex justify-evenly">
                ...
                <div className="h-fit mr-5 lg:hidden flex items-center hover:scale-90 transition-all duration-500 hover:cursor-pointer" onClick={() => { setShowMenu(!showMenu) }} >
